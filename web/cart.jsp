...
<html>
    ...
    <body>
        ...
        <section id="mainContainer">
            <div class="about" >
                <h2 style="font-size:50px;font-family:Time New Roman">Cart of <span style="color: red;">#<%=us%></span> </h2>
                <table style="width: 50%;height: 100%;" border="1px solid black" align="center">
                    ...
                    <%
                        ...
                        for (Order o : list) {
                              totalPriceCart += o.getTotalPrice();
                ...
                <div>
                    <p>Total Price Of This Cart: <%=totalPriceCart%></p>
                </div>
                <form method="post" action="shoppingcart?totalPriceCart=<%= totalPriceCart %>&username=<%= us %>">
